...
|	151.反转字符串中的单词 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Two%20Pointers/0151.reverse_words_in_a_string.md) | 字符串、双指针 | 中等 |
...
|	161.相隔为 1 的编辑距离| [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Two%20Pointers/0161.one_edit_distance.md) | 字符串、双指针 | 中等 |
|	0167 | 167.两数之和 II - 输入有序数组 | [JS/Python](https://github.com/donnapersonal/solve_leetcode/blob/main/Two_pointers/0167.two_sum_II-input_array_is_sorted.md) | 数组、双指针 | 中等 |
...
|	1868.两个行程编码数组的积 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Two%20Pointers/1868.product_of_two_run-length_encoded_arrays.md) | 数组、双指针 | 中等 |
...
|	68.文本左右对齐 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Simulation_Design/0068.text_justification.md) | 字符串、模拟 | 困难 |
...
|	166.分数到小数 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Simulation_Design/166.fraction_to_recurring_decimal.md) | 模拟、哈希 | 中等 |
|	237.删除链表中的节点 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Simulation_Design/0237.delete_node_in_a_linked_list.md) | 链表 | 中等 |
|	289.生命游戏 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Simulation_Design/0289.game_of_life.md) | 矩阵、模拟 | 中等 |
...
|	468.验证IP地址 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Simulation_Design/0468.validate_IP_address.md) | 模拟 | 中等 |
|	498.对角线遍历 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Simulation_Design/0498.diagonal_traverse.md) | 模拟 | 中等 |
|	535.TinyURL 的加密与解密| [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Simulation_Design/0535.encode_and_decode_tinyURL.md) | 设计、哈希 | 中等 |
...
|	707.设计链表 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Simulation_Design/0707.design_linked_list.md) | 链表、设计 | 中等 |
...
|	1206.设计跳表 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Simulation_Design/1206.design_skiplist.md) | 设计、数据结构 | 困难 |
...
|	1700.无法吃午餐的学生数量 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Simulation_Design/1700.number_of_students_unable_to_eat_lunch.md) | 设计、计数法、贪心 | 简单 |
...
|	636.函数的独占时间 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Stack/0636.exclusive_time_of_functions.md) | 数组、栈 | 中等 |
...
|	1081.不同字符的最小子序列 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Stack/1081.smallest_subsequence_of_distinct_characters.md) | 字符串、单调栈 | 中等 |
|	1762.能看到海景的建筑物 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Stack/1762.buildings_with_an_ocean_view.md) | 数组、栈、单调栈 | 中等 |
...
|	211.添加与搜索单词 - 数据结构设计 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Trie/0211.design_add_and_search_words_data_structure.md) | 设计、字典树 | 中等 |
...
|	1065.字符串的索引对 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Trie/1065.index_pairs_of_a_string.md) | 字符串、字典树 | 简单 |
...
|	261.以图判树 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/0261.graph_valid_tree.md) | Union-Find | 中等 |
|	269.火星词典 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/0269.alien_dictionary.md) | 拓扑排序 | 困难 |
|	286.墙与门 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/0286.walls_and_gates.md) | BFS | 困难 |
|	323.无向图中连通分量的数目 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/0323.number_of_connected_components_in_an_undirected_graph.md) | BFS、DFS、Union-Find | 中等 |
...
|	684.冗余连接 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/0684.redundant_connection.md) | Union-Find | 中等 |
|	694.不同岛屿的数量 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/0694.number_of_distinct_islands.md) | BFS、DFS、Union-Find | 中等 |
...
|	743.网络延迟时间 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/0743.network_delay_time.md) | Dijkstra | 中等 |
|	785.网络延迟时间 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/0785.is_graph_bipartite.md) | Dijkstra | 中等 |
...
|	815.公交路线 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/0815.bus_routes.md) | BFS | 困难 |
|	834.树中距离之和 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/0834.sum_of_distances_in_tree.md) | BFS | 困难 |
|	909.蛇梯棋 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/0909.snakes_and_ladders.md) | BFS | 中等 |
|	924.尽量减少恶意软件的传播 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/0924.minimize_malware_spread.md) | BFS、DFS、Union-Find | 困难 |
...
|	1136.并行课程 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/1136.parallel_courses.md) | Topological Sort | 中等 |
...
|	1298.你能从盒子里获得的最大糖果数 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/1298.maximum_candies_you_can_get_from_boxes.md) | BFS |困难 |
...
|	1976.到达目的地的方案数 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/1976.number_of_ways_to_arrive_at_destination.md) | Topological Sort | 中等 |
...
|	2924. 寻找冠军 II | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/2924.find_champion_II.md) |  | 中等 |
|	2959.关闭分部的可行集合数目 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Graph/2959.number_of_possible_sets_of_closing_branches.md) |  | 困难 |
...
|	426.将二叉搜索树转化为排序的双向链表 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Binary%20Tree/0426.convert_binary_search_tree_to_sorted_doubly_linked_list.md) | 二叉树、递归 | 中等 |
|	427.建立四叉树 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Binary%20Tree/0427.construc_quad_tree.md) | 二叉树、递归 | 中等 |
|	437.路径总和 III | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Binary%20Tree/0437.path_sum_III.md) | 二叉树、DFS | 中等 |
|	501.二叉搜索树中的众数 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Binary%20Tree/0501.find_mode_in_binary_search_tree.md) | 二叉树、中序、Morris 中序 | 简单 |
|	513.找树左下角的值 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Binary%20Tree/0513.find_bottom_left_tree_value.md) | 二叉树、DFS、BFS | 中等 |
...
|	863.二叉树中所有距离为 K 的结点 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Binary%20Tree/0863.all_nodes_distance_K_in_binary_tree.md) | 二叉树、BFS、DFS | 中等 |
|	968.监控二叉树 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Binary%20Tree/0968.binary_tree_cameras.md) | 二叉树、动态规划 | 困难 |
|	1123.最深叶节点的最近公共祖先 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Binary%20Tree/1123.lowest_common_ancestor_of_deepest_leaves.md) | 二叉树、递归 | 中等 |
|	2265.统计值等于子树平均值的节点数 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Binary%20Tree/2265.count_nodes_equal_to_average_of_subtree.md) | 二叉树、DFS | 中等 |
...
|	334.递增的三元子序列 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Greedy/0334.increasing_triplet_subsequence.md) | 数组、贪心 | 中等 |
...
|	1219 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Backtracking/1219.path_with_maximum_gold.md) | 矩阵、回溯 | 中等 |
|	1240.铺瓷砖 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Backtracking/1240.tiling_a_rectangle_with_the_fewest_squares.md) | 回溯 | 困难 |
...
| 题目 | 题解 | 标签 | 难度 |
|	10.正则表达式匹配 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/0010.regular_expression_matching.md) | 动态规划 | 困难 |
...
|	91.解码方法 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/0091.decode_ways.md) | 字符串、动态规划 | 中等 |
...
|	188.买卖股票的最佳时机 IV | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/0188.best_time_to_buy_and_sell_stock_IV.md) | 动态规划 | 困难 |
...
|	265.粉刷房子 II | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/0265.paint_house_II.md) | 动态规划 | 困难 |
...
|	518.零钱兑换 II | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/0518.coin_change_II.md) | 数组、动态规划 | 中等 |
|	638.大礼包 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/0638.shopping_offers.md) | 数组、记忆化搜索 | 中等 |
|	740.删除并获得点数 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/0740.delete_and_earn.md) | 数组、动态规划 | 中等 |
|	828.统计子串中的唯一字符 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/0828.coun_unique_characters_of_all_substrings_of_a_given_string.md) | 字符串、动态规划 | 困难 |
|	887.鸡蛋掉落 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/0887.super_egg_drop.md) | 字符串、动态规划 | 困难 |
|	983.最低票价| [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/0983.minimum_cost_for_tickets.md) | 数组、动态规划 | 中等 |
|	1027.最长等差数列 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/1027.longest_arithmetic_subsequencen.md) | 数组、动态规划 | 中等 |
|	1027.最长等差数列 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/1049.last_stone_weight_II.md) | 数组、动态规划 | 中等 |
...
|	1235.规划兼职工作 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/1235.maximum_profit_in_job_scheduling.md) | 数组、动态规划 | 困难 |
|	1312.让字符串成为回文串的最少插入次数 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/1312.minimum_insertion_steps_to_make_a_string_palindrome.md) | 字符串、动态规划 | 困难 |
...
|	3181.执行操作可获得的最大总奖励 II | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/3181.maximum_total_reward_using_operations_II.md) | 数组、动态规划 | 困难 |
...
|	3193.统计逆序对的数目 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/3193.count_the_numbe_of_inversions.md) | 数组、动态规划 | 困难 |
...
|	3332.旅客可以得到的最多点数 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Dynamic%20Programming/3332.maximum_points_tourist_can_earn.md) | 矩阵、动态规划 | 中等 |
...
|	28.找出字符串中第一个匹配项的下标 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Multiple_Ideas/0028.find_the_index_of_the_first_occurrence_in_a_string.md) | 字符串、滑动窗口、双指针、字符串匹配算法（BF/BM/KMP/RK/Horspool/Sunday）| 简单 |
...
|	67.二进制求和 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Multiple_Ideas/0067.add_binary.md) | 字符串、位运算、数学、模拟 | 简单 |
...
|	214.最短回文串 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Multiple_Ideas/0214.shortest_palindrome.md) | 字符串、Rabin-Karp、KMP | 困难 |
...
|	220.存在重复元素 III | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Multiple_Ideas/0220.contains_duplicate_III.md) | 数组、桶排序、滑动窗口 | 困难 |
...
|	376.摆动序列 | [JS/Python](https://github.com/donnapersonal/solve_lc/blob/main/Multiple_Ideas/0376.wiggle_subsequence.md) | 数组、贪心、动态规划 | 困难 |
